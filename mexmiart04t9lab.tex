...
\lstinputlisting[language=Lisp, numbers=left, columns=fullflexible, caption=domain.pddl \label{sc:domain.pddl}]{domain.pddl}
...
\lstinputlisting[language=Lisp, numbers=left, caption=problem02.pddl \label{sc:problem02.pddl}]{problem02.pddl}
\lstinputlisting[language=Lisp, numbers=left, caption=problem03.pddl \label{sc:problem03.pddl}]{problem03.pddl}
...
\lstinputlisting[style=consola, numbers=left, columns=fullflexible, caption=Resultado de FF \label{sc:p1-ff.pddl}]{out/p1-ff}
...
\begin{lstlisting}[style=consola, numbers=left, caption=Resultado de Metis \label{sc:Metis}]
  ...
  Peak memory: 4960 KB
\end{lstlisting}
\begin{lstlisting}[style=consola, numbers=left, caption=Resultado de Scorpion \label{sc:Scorpion}]
  Solution found!
  Actual search time: 0s [t=200.014s]
  move hospital l2 (1)
  move l2 l4 (1)
  move l4 l3 (1)
  getinto patient1 l3 ambulance (1)
  ...
  Reopened until last jump: 0 state(s).
  Evaluated until last jump: 24 state(s).
  Generated until last jump: 36 state(s).
  Number of registered states: 37
  Int hash set load factor: 37/64 = 0.578125
  Int hash set resizes: 6
  total successors before partial-order reduction: 58
  total successors after partial-order reduction: 58
  Number of times each order was the best order: [16, 11, 0, 6, 3]
  Probably useful orders: 4/5 = 80%
  Search time: 0.000681004s
  Total time: 200.014s
  Solution found.
  Peak memory: 5512 KB
  exitcode: 0
...
\lstinputlisting[language=Lisp, numbers=left, caption=problem04.pddl \label{sc:problem04.pddl}]{problem04.pddl}
