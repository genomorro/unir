...
\label{sec:org983a4eb}

El algoritmo A\textsuperscript{*} es considerado comúnmente como una mejora de Dijkstra (cap. \citeprocitem{2}{Domkin, 2021, p. 7}). La estimación heurística más común del algoritmo es la mostrada en la ecuación \ref{org05b0ec0}.
...
Dentro de \ref{org05b0ec0} la función \(g(u)\)  calcula el coste del actual camino, mientras que \(h(u)\) es la estimación heurística del coste restante hasta el objetivo, por lo tanto \(f(u)\) es la aproximación total del coste de la ruta. (\citeprocitem{3}{Edelkamp \& Schroedl, 2011, p. 69})
