...
Este documento corresponde a un análisis de datos que relacionan
información de tarjetas de crédito con operaciones denominadas
fraudulentas. Se usarán algoritmos de aprendizaje automático no
supervisado para encontrar una posible identificación de estas
operaciones fraudulentas.

En caso de que el lector decida replicar por su cuenta el procedimiento
detallado en este documento, se recomienda consultar los archivos fuente
en el \href{https://github.com/genomorro/unir/tree/AA-A2}{repositorio
del proyecto}.
...
memory usage: 216.3+ KB
    ...
    \hypertarget{datos-estaduxedsticos-de-variables-numuxe9ricas}{%
\subsection{Datos estadísticos de variables
numéricas}\label{datos-estaduxedsticos-de-variables-numuxe9ricas}}
...
\end{tcolorbox}
    ...
    \hypertarget{categoruxedas-y-frecuencias-de-variables-categuxf3ricas}{%
\subsection{Categorías y frecuencias de variables
categóricas}\label{categoruxedas-y-frecuencias-de-variables-categuxf3ricas}}

Se inciará mostrando el estado original de las tres variables
categóricas.
...
variable original y se adjuntan las nuevas variables al dataframe.
...
con un principio matemático, en este momento dicho proceder escapa de
los propósitos de este documento. En este análisis se procederá
directamente a implementar un método de agrupamiento.

    \hypertarget{aplicaciuxf3n-de-una-tuxe9cnica-de-agrupamiento-jeruxe1rquico}{%
\section{Aplicación de una técnica de agrupamiento
jerárquico}\label{aplicaciuxf3n-de-una-tuxe9cnica-de-agrupamiento-jeruxe1rquico}}
...
similares son los objetos
agrupados.~\citep{The_SciPy_community_2022a}
...
\subsection{Recuperar clusters}\label{recuperar-clusters}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{Z1} \PY{o}{=} \PY{n}{linkage}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{isForeignTransaction\PYZus{}Y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{isHighRiskCountry\PYZus{}Y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Transaction\PYZus{}amount}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Total Number of declines/day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{centroid}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{c1}\PY{p}{,} \PY{n}{d1} \PY{o}{=} \PY{n}{cophenet}\PY{p}{(}\PY{n}{Z1}\PY{p}{,} \PY{n}{pdist}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{isForeignTransaction\PYZus{}Y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{isHighRiskCountry\PYZus{}Y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Transaction\PYZus{}amount}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Total Number of declines/day}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Distancia de correlación cophenetic Z1:  0.8930191088848004
...
Accuracy:  0.8747967479674796
    ...
    \hypertarget{aplicaciuxf3n-de-una-tuxe9cnica-de-detecciuxf3n-de-anomaluxedas}{%
\section{Aplicación de una técnica de detección de
anomalías}\label{aplicaciuxf3n-de-una-tuxe9cnica-de-detecciuxf3n-de-anomaluxedas}}
...
anomalías: el \emph{isolation forest}.
...
un fraude. También es posible inspeccionar el bosque, seleccionar un
árbol creado en alguna iteración y ver la relevancia de la información
para dicho árbol. Esta relevancia será variable en cada árbol, aquí solo
se muestra un ejemplo.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{24}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Feature}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{ifc}\PY{o}{.}\PY{n}{feature\PYZus{}names\PYZus{}in\PYZus{}}\PY{p}{,}
 \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Importance}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{ifc}\PY{o}{.}\PY{n}{estimators\PYZus{}}\PY{p}{[}\PY{l+m+mi}{9950}\PY{p}{]}\PY{o}{.}\PY{n}{feature\PYZus{}importances\PYZus{}}\PY{p}{\PYZcb{}}\PY{p}{)}\PY{o}{.}\PY{n}{sort\PYZus{}values}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Importance}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
                          Feature  Importance
6                   Is declined\_Y    0.013997
3        Daily\_chargeback\_avg\_amt    0.038070
8             isHighRiskCountry\_Y    0.043411
5               6-month\_chbk\_freq    0.050278
0  Average Amount/transaction/day    0.091543
2    Total Number of declines/day    0.159528
1              Transaction\_amount    0.165508
4            6\_month\_avg\_chbk\_amt    0.172281
7          isForeignTransaction\_Y    0.265384
\end{Verbatim}
\end{tcolorbox}
...
proyecto, visible desde el enlace provisto en la introducción.
...
\PY{n}{df}\PY{p}{[}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{isFradulent}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Clustering prediction\PYZus{}Y=1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Isolation Forest prediction\PYZus{}N=1}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
