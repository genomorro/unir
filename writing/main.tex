...
La variable objetivo es ``price\_range''. En este análisis
...
En el presente análisis se comparará el funcionamiento  de una SVM y una red neuronal básica, por
lo tanto, se requieren  las bibliotecas  de `sklearn`  y `tensorflow`.  Además, se  han ajustado
parámetros para visualizar correctamente las imágenes generadas en este reporte.
...
memory usage: 328.2 KB
    ...
    Los metadatos del dataframe corresponden al siguiente diccionario. De
esta forma, es posible saber que significa un dato en particular. Esto
puede no ser indispensable para el código, pero si resulta de gran
importancia en la interpretación y análisis de resultados.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{4}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{metadata} \PY{o}{=} \PY{p}{\PYZob{}}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{battery\PYZus{}power}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Capacidad de la batería mAh}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{blue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tiene bluetooth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{clock\PYZus{}speed}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Velocidad de reloj del microprocesador}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{dual\PYZus{}sim}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tiene soporte dual sim}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fc}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Resolución de cámara frontal en megapíxeles}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{four\PYZus{}g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tiene 4G}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{int\PYZus{}memory}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Memoria interna en Gigabytes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{m\PYZus{}dep}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Profundidad móvil en cm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mobile\PYZus{}wt}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Peso del teléfono móvil}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n\PYZus{}cores}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Número de núcleos del procesador}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{pc}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Megapíxeles de la cámara principal}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{px\PYZus{}height}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Altura de resolución de píxeles}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{px\PYZus{}width}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ancho de resolución de píxeles}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ram}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Memoria RAM en megabytes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sc\PYZus{}h}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Altura de la pantalla del móvil en cm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sc\PYZus{}w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ancho de pantalla del móvil en cm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{talk\PYZus{}time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Máximo tiempo que durará una sola carga de batería cuando se habla por teléfono}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tres\PYZus{}g}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tiene 3G}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{touch\PYZus{}screen}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tiene pantalla táctil}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{wifi}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Tiene wifi}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
    \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{price\PYZus{}range}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rango de precios de 0 (costo bajo), 1 (costo medio), 2 (costo alto), 3 (costo muy alto)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
\PY{p}{\PYZcb{}}
\PY{n}{metadata}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n\PYZus{}cores}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    Aun así parece que no todas las variables son realmente numéricas, pues
...
categorías, mismas que se detallan en los metadatos.
...
\PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{n}{metadata}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{price\PYZus{}range}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{12}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
Text(0.5, 1.0, 'Rango de precios de 0 (costo bajo), 1 (costo medio), 2 (costo
...
\PY{n}{fig}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{21}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{cv}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}
...
\PY{n}{fig}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{64}\PY{p}{)}\PY{p}{)}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{nv}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{l+m+mi}{14}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{image0.png}
    \end{center}
    \begin{center}
    ...
    \end{center}
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{image11.png}
    \end{center}
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{image12.png}
    \end{center}
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{image13.png}
    \end{center}
    { \hspace*{\fill} \\}
...
la variable \texttt{ram}, tenga una correlación alta respecto a
\texttt{price\_range}, mientras otras como \texttt{clock\_speed} sean de
muy poca relevancia. No hay que perder de vista que la correlación es
distinto a la causa: la correlación indica que el valor de ambas
variables depende de la misma causa.
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={1.2\linewidth}{1.2\paperheight}}{output_18_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
estructura básica donde hay tres capas con 16, 12 y 4 neuronas; las
primeras dos tienen función de activación \texttt{relu} y la última
\texttt{softmax}. \citep{rickytb2021, Keras2022}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{historial} \PY{o}{=} \PY{n}{nn}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{train}\PY{p}{[}\PY{n}{predictors}\PY{p}{]}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{ravel}\PY{p}{(}\PY{n}{train}\PY{p}{[}\PY{n}{target}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{epochs}\PY{o}{=}\PY{l+m+mi}{600}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,} \PY{n}{verbose}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
2022-04-24 19:02:24.795969: W tensorflow/stream\_executor/platform/default/dso\_loader.cc:55] Could not load dynamic library 'libcuda.so.1'; dlerror: libcuda.so.1: cannot open shared object file: No such file or directory
2022-04-24 19:02:24.796021: E tensorflow/stream\_executor/cuda/cuda\_driver.cc:318] failed call to cuInit: UNKNOWN ERROR (303)
2022-04-24 19:02:24.796055: I tensorflow/stream\_executor/cuda/cuda\_diagnostics.cc:156] kernel driver does not appear to be running on this host (jupyter-genomorro-2dunir-2djkvlkign): /proc/driver/nvidia/version does not exist
2022-04-24 19:02:24.796895: I tensorflow/core/platform/cpu\_feature\_guard.cc:142] Your CPU supports instructions that this TensorFlow binary was not compiled to use: AVX2 FMA
2022-04-24 19:02:24.803463: I tensorflow/core/platform/profile\_utils/cpu\_utils.cc:94] CPU Frequency: 2299995000 Hz
2022-04-24 19:02:24.804009: I tensorflow/compiler/xla/service/service.cc:168] XLA service 0x55ab9e131980 initialized for platform Host (this does not guarantee that XLA will be used). Devices:
2022-04-24 19:02:24.804053: I tensorflow/compiler/xla/service/service.cc:176] StreamExecutor device (0): Host, Default Version
    \end{Verbatim}

    En la siguiente gráfica se observa que incluso con 600 epoch el modelo continúa disminuyendo
    la  pérdida, aunque  la rapidez  disminuye  al acercarse  a los  500  epoch, por  lo que  se
    considera un buen valor para el entrenamiento.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{18}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZsh{} Epoch}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Magnitud de pérdida}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{historial}\PY{o}{.}\PY{n}{history}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{loss}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
%% \begin{Verbatim}[commandchars=\\\{\}]
%% [<matplotlib.lines.Line2D at 0x7f12384a8110>]
%% \end{Verbatim}
%% \end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.65\linewidth}{0.65\paperheight}}{output_32_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\citep{rickytb2021}. Para ello se crea una función que realice esta
conversión.
...
La red neuronal  no ha alcanzado la gran precisión  que logró la SVM pero el  resultado no se ha
alejado realmente.  Si se  considera que  este modelo fue  creado a  partir de  la documentación
básica de  la biblioteca que  lo implementa  y no ha  sido totalmente personalizado,  es posible
pensar que el resultado es positivo y podría alcanzar mejores predicciones con mayor tiempo.

Algo que si se puede destacar es la distribución del error, como es posible observar, en la clase 2 se presentan tres errores, dos de ellos cayeron en la clase 1 y otro en la clase 3, en otras palabras, existen falsos positivos y falsos negativos. Esto no se dio en la SVM, donde el error solo se observó entre dos categorías y en sentido de los falsos positivos.
...
weighted avg       0.96      0.96      0.96       400
    ...
    Los resultados son realmente igualados. Los mejores números presentados
por la SVM no hacen gran diferencia. En el \emph{recall}, la capacidad del
clasificador para encontrar todas las muestras positivas, ambos modelos pueden tener
