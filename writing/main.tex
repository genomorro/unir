\documentclass[11pt,a4paper,table]{article}
    ...
    % Document parameters
    % Document title
    \title{Actividad: Evaluación de la segmentación}
...
\makeatother
    ...
    \hypersetup{
      ...
      pdftitle={Actividad: Evaluación de la segmentación},
      pdfkeywords={segmentación, Percepción Computacional, imágenes, umbral, Canny, color},
...
\textcolor{UnirDark}{\Large\bfseries\newtitle}\label{evaluaciuxf3n-de-la-segmentaciuxf3n}}

\hypertarget{declaraciuxf3n-de-libreruxedas}{%
\subsection*{Declaración de
librerías}\label{declaraciuxf3n-de-libreruxedas}}
...
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Número de contornos/objetos encontrados: }\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{contours}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\texttt{img\_10t}, debido a lo angosto de la parte media del dibujo
pueden ser identificados como dos objetos y no como uno. A continuación
se presenta una lista con la relación de objetos y contornos detectados:
...
con un filtro gaussiano como primer paso. Parece ser que no es
...
\texttt{thresh} tenga el valor ideal\citep{Madhav2019Image}. Aquí se
...
Así como sucede en el caso de la imagen \texttt{img\_10t}, es posible
que este método encuentre como contorno más externo los límites de la
...
eleva demasiado el número de bordes encontrados en la imagen. Aquí se ha
...
que se encuentren en un rango de color.\citep{Maindola20214}
...
Lo anterior puede ser muy útil para encontrar muchos objetos que
compartan el mismo rango de color, en este caso, todos los objetos rojos
o negros.

\hypertarget{conclusiuxf3n}{%
\subsection*{Conclusión}\label{conclusiuxf3n}}

La segmentación de una imagen es un trabajo de precisión. Es necesario
